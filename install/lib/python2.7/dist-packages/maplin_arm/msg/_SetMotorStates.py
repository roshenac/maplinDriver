...
"""autogenerated by genpy from maplin_arm/SetMotorStates.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import maplin_arm.msg
import std_msgs.msg

class SetMotorStates(genpy.Message):
  _md5sum = "56722fcd842fbf3dbe76bd48941f870f"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetMotorStates, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = maplin_arm.msg.MotorState()
        _x = val1
        start = end
        end += 8
